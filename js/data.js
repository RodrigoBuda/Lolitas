export const services = [
  ...
  },
  {
    ...
    category: "labios",
    description:
      "El servicio de labios con Dermapen es un tratamiento de belleza no invasivo que mejora la apariencia y salud de los labios. Este tratamiento utiliza el dispositivo de microagujas Dermapen para estimular la producción de colágeno y elastina, dejando los labios más suaves, firmes y rejuvenecidos en una sola sesión. Es seguro, efectivo y sin tiempo de inactividad. ¡Luce unos labios más jóvenes y saludables con este tratamiento!",
  ...
  },
  {
    ...
    category: "cejas",
    description:
      "La depilación con hilo es una técnica de depilación que se originó en Asia y ha ganado popularidad en Occidente en los últimos años. Utiliza un hilo de algodón retorcido para eliminar vellos no deseados de manera precisa y natural, sin productos químicos. Es especialmente beneficiosa para dar forma y definir las cejas y tiene resultados más duraderos y menos irritantes que la depilación con cuchilla o cera. Es una técnica natural y precisa que se ha utilizado durante siglos y ofrece una alternativa a la depilación con cera o cuchilla.",
    image: "../img/hilo.jpg",
    price: "$1400",
  },
